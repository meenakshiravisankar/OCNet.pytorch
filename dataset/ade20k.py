## Author: Meenakshi Ravisankar
## IIT Madras
## ravisankarmeenakshi@gmail.com
...
class Ade20kSegmentationTrain(data.Dataset):
...
class Ade20kSegmentationTest(data.Dataset):
    def __init__(self, root, list_path, max_iters=None, crop_size=(321, 321),
...
class Ade20kSegmentationTrainWpath(data.Dataset):
    def __init__(self, root, list_path, max_iters=None, crop_size=(321, 321),
...
if __name__ == '__main__':
    dst = Ade20kSegmentationTrain("./ade20k/", "./list/ade20k/train.lst", crop_size=(1024, 2048))
    trainloader = data.DataLoader(dst, batch_size=1, num_workers=0)

    with open("./list/ade20k/train.lst") as f:
        train_list = f.readlines()
    train_list = [x.strip() for x in train_list] 

    # f_w = open("./list/ade20k/bus_truck_train.lst", "w")
    cnt = np.zeros(19)
