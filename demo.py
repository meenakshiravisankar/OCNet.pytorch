...
def main():
    ...
    model = get_segmentation_model("_".join(["resnet101", "base_oc_dsn"]), num_classes=26)
    os.environ["CUDA_VISIBLE_DEVICES"]="0"    
    saved_state_dict = torch.load("checkpoint/snapshots_resnet101_base_oc_dsn_5e-3_5e-4_1_40000/CS_scenes_1000.pth")
