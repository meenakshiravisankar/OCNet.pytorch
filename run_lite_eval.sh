...
DATA_LIST_PATH='./dataset/list/idd_lite/train.lst'
...
WHOLE_SCALE='1'
TEST_RESTORE_FROM="./checkpoint/snapshots_resnet101_interlaced_dsn_1e-2_5e-4_4_10000/CS_scenes_4000.pth"
...
mkdir -p visualize
# validation set
TESTDATASET="lite_train"
TEST_SET="val"
TEST_DATA_LIST_PATH="./dataset/list/idd_lite/val.lst"
...
TESTDATASET="lite_train"
TEST_SET="train"
TEST_DATA_LIST_PATH="./dataset/list/idd_lite/train.lst"
TEST_LOG_FILE="./log/log_test/log_result_${NETWORK}_${METHOD}_${TEST_SET}_${LEARNING_RATE}_${WEIGHT_DECAY}_${BATCHSIZE}_${MAX_ITERS}_${PREDICT_CHOICE}"
TEST_OUTPUT_PATH="./visualize/${NETWORK}_${METHOD}_${TEST_SET}_${LEARNING_RATE}_${WEIGHT_DECAY}_${BATCHSIZE}_${MAX_ITERS}/"
...
## test set
TEST_STORE_RESULT=True
TESTDATASET="lite_test"
TEST_SET="test"
TEST_DATA_LIST_PATH="./dataset/list/idd_lite/test.lst"
TEST_LOG_FILE="./log/log_test/log_result_${NETWORK}_${METHOD}_${TEST_SET}_${LEARNING_RATE}_${WEIGHT_DECAY}_${BATCHSIZE}_${MAX_ITERS}_${PREDICT_CHOICE}"
TEST_OUTPUT_PATH="./visualize/${NETWORK}_${METHOD}_${TEST_SET}_${LEARNING_RATE}_${WEIGHT_DECAY}_${BATCHSIZE}_${MAX_ITERS}/"
