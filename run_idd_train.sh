...
DATA_LIST_PATH='./dataset/list/idd/train_2.lst'
RESTORE_FROM='mlruns/7/train_26/artifacts/CS_scenes_40000.pth'
...
#  Training
########################################################################################################################
$PYTHON -u train.py --fine-tune --resume-training --num-classes $NUM_CLASSES --experiment-name $EXPERIMENT_NAME --network $NETWORK --method $METHOD --random-mirror --random-scale --gpu 0,1,2,3 --batch-size $BATCHSIZE \
